...
def get_subject(data: GameSubject):
    ...
    prompt = FewShotPromptTemplate(
        ...
        suffix="""
            ...
            단 아래 조건을 반드시 지키면서 대답해. 조건을 지키지 못하면 조건을 지킬 수 있을때까지 대답하지마.
            ...
            4. {title} 이 '애니메이션' 과 관련된 주제라면 [원피스, 나루토, 블리치] 중 2가지는 제외하하고 대답해.
            5. {title} 이 '게임' 과 관련된 주제라면 [리그오브레전드, 워크프래프트, 리니지, 메이플스토리] 중 2가지는 제외하하고 대답해
        """,
